...
<?php echo do_shortcode('[wpbs id="1" form="1" title="yes" legend="yes" dropdown="no" start="7" display="1" language="auto" history="1" tooltip="1" month="0" year="0" selection="multiple" autopending="no" weeknumbers="no" minimumdays="0" formposition="below"]'); ?>
</div>
<?php /* END TESTING */ ?>
